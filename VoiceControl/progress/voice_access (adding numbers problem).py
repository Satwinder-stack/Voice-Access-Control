...
- delete [number] times → backspace
    ...
    if cmd.startswith("add "):
        phrase = cmd[4:].strip()
        symbols = {
            # Single digits (your original + variations)
            "zero": "0", "zero.": "0", "number zero": "0", "number zero.": "0",
            "one": "1", "one.": "1", "number one": "1", "number one.": "1",
            "two": "2", "two.": "2", "number two": "2", "number two.": "2",
            "three": "3", "three.": "3", "number three": "3", "number three.": "3",
            "four": "4", "four.": "4", "number four": "4", "number four.": "4",
            "five": "5", "five.": "5", "number five": "5", "number five.": "5",
            "six": "6", "six.": "6", "number six": "6", "number six.": "6",
            "seven": "7", "seven.": "7", "number seven": "7", "number seven.": "7",
            "eight": "8", "eight.": "8", "number eight": "8", "number eight.": "8",
            "nine": "9", "nine.": "9", "number nine": "9", "number nine.": "9",
            "1": "1", "1.": "1", "number 1": "1", "number 1.": "1",
            "2": "2", "2.": "2", "number 2": "2", "number 2.": "2",
            "3": "3", "3.": "3", "number 3": "3", "number 3.": "3",
            "4": "4", "4.": "4", "number 4": "4", "number 4.": "4",
            "5": "5", "5.": "5", "number 5": "5", "number 5.": "5",
            "6": "6", "6.": "6", "number 6": "6", "number 6.": "6",
            "7": "7", "7.": "7", "number 7": "7", "number 7.": "7",
            "8": "8", "8.": "8", "number 8": "8", "number 8.": "8",
            "9": "9", "9.": "9", "number 9": "9", "number 9.": "9",


            "space.": " ", "spacebar.": " ", "space bar.": " ", "space": " ",
            "question mark.": "?", "question.": "?", "question": "?", 
            "exclamation mark.": "!", "exclamation point": "!", "exclamation.": "!", "exclamation": "!",
        ...
        if phrase in symbols:
            ...
            speak(f"{phrase.title()} added")
            return
        
        # === SPOKEN NUMBERS (ROBUST PARSER) ===
        clean_phrase = phrase.replace("number ", "").replace(".", "").replace("-", " ")
            ...
            while i < len(words):
                ...
                if word in number_words:
                    ...
                    if value >= 1000:  # thousand, million, billion
                        current = current or 1  # if no number before, assume "one"
                        total += current * value
                        current = 0
                        ...
                        # Tens and units
                        if current > 0 and value < 10 and current < 100:
                            # e.g., "twenty three" → current = 20, then add 3 → 23
                            current = current * 10 + value if current < 10 else current + value
                        else:
                            current += value
                    i += 1
                else:
                    i += 1  # skip unknown words
